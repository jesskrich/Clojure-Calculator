...
var c_25903 = (a[i]);
if(cljs.core.truth_((c_25903["cljsIsDirty"]))){
(c_25903["forceUpdate"])();
} else {
}
...
var G__25907 = c;
var G__25907__$1 = (((G__25907 == null))?null:(G__25907["props"]));
if((G__25907__$1 == null)){
return null;
} else {
return (G__25907__$1["argv"]);
}
});
...
var G__25909_25910 = (c["cljsRatom"]);
if((G__25909_25910 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__25909_25910);
}
