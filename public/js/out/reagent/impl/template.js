...
var G__25967 = o;
(G__25967[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_25971 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_25971))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_25971)].join(''):class$));
} else {
}
...
var G__25974 = jsprops;
(G__25974["defaultValue"] = value);

(G__25974["onChange"] = ((function (G__25974,v,value,on_change){
return (function (p1__25972_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25972_SHARP_);
});})(G__25974,v,value,on_change))
);
...
var vec__25976 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25976,(0),null);
var id = cljs.core.nth.call(null,vec__25976,(1),null);
var class$ = cljs.core.nth.call(null,vec__25976,(2),null);
...
var temp__4659__auto__ = (function (){var G__25980 = cljs.core.meta.call(null,v);
if((G__25980 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__25980);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__25982_25983 = v;
var G__25982_25984__$1 = (((G__25982_25983 == null))?null:reagent.impl.template.key_from_vec.call(null,G__25982_25983));
if((G__25982_25984__$1 == null)){
} else {
(jsprops["key"] = G__25982_25984__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__25987 = cljs.core.meta.call(null,argv);
if((G__25987 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__25987);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__25988 = (((jsprops == null))?{}:jsprops);
(G__25988["key"] = key);
...
var G__25989 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__25989;
continue;
}
} else {
...
var n__19273__auto___25990 = a.length;
var i_25991 = (0);
while(true){
if((i_25991 < n__19273__auto___25990)){
(a[i_25991] = reagent.impl.template.as_element.call(null,(a[i_25991])));

var G__25992 = (i_25991 + (1));
i_25991 = G__25992;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19273__auto___25993 = a.length;
var i_25994 = (0);
while(true){
if((i_25994 < n__19273__auto___25993)){
var val_25995 = (a[i_25994]);
if((cljs.core.vector_QMARK_.call(null,val_25995)) && ((reagent.impl.template.key_from_vec.call(null,val_25995) == null))){
(o["no-key"] = true);
} else {
}

(a[i_25994] = reagent.impl.template.as_element.call(null,val_25995));

var G__25996 = (i_25994 + (1));
i_25994 = G__25996;
continue;
} else {
}
...
var G__25998 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25998) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__25998){
